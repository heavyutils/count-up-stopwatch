...
## License
If you plan to publicly redistribute an edited version of Count-Up Stopwatch: In AssemblyInfo.cs, the variables AssemblyTitle AND AssemblyProduct must contain "(fork)".
